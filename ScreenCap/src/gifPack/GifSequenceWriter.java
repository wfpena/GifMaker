...
public class GifSequenceWriter {
	...
	//	if (args.length > 1) {
			...
			BufferedImage firstImage = robot.createScreenCapture(new Rectangle(Toolkit.getDefaultToolkit().getScreenSize()));
			//ImageIO.write(fImage, "GIF", new File("C:\\Users\\USER\\Desktop\\sreenShot.gif"));
			//BufferedImage firstImage = ImageIO.read( new File("C:\\Users\\USER\\Desktop\\sreenShot.gif"));
			
			// create a new BufferedOutputStream with the last argument
			ImageOutputStream output = new FileImageOutputStream(new File("C:\\Users\\USER\\Desktop\\Out.gif"));
			...
			for(int i=0;i<=10;i++){
				...
				BufferedImage nImage = robot.createScreenCapture(new Rectangle(Toolkit.getDefaultToolkit().getScreenSize()));
				//ImageIO.write(nextImage, "GIF", new File("C:\\Users\\USER\\Desktop\\sreenShot.gif"));
				//BufferedImage nImage = ImageIO.read( new File("C:\\Users\\USER\\Desktop\\sreenShot.gif"));
				//System.out.println(nImage == nextImage);
				writer.writeToSequence(nImage);
			}
			//}
